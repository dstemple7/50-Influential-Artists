...
*/
  ...
  function getArtistByIndex(artists, id) {
    const infoByIndex = artists[id];
    return `The artist at index ${infoByIndex.id} is ${infoByIndex.name}`
  }
...
function addArtist(){
  let David = { "id": 21, "name": "David Temple", "years": "1986 - present", "genre": "Various", "nationality": "Global","bio": "Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum.", "wikipedia": "Coming soon!", "paintings": 1}
  artists.push(David);
  return artists
  }
